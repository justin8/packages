...
Packager: Justin Dray <justin@dray.be>
Vendor: RepoForge RPM Repository, http://pkgs.repoforge.org/nagios/

Source0: http://prdownloads.sourceforge.net/sourceforge/nagios/nagios-%{version}.tar.gz
Source1: daemon-init-redhat.in
...
%{!?el3:%{__cp} -f %{SOURCE1} daemon-init.in}
...
%changelog
* Thu Oct 17 2013 Justin Dray <justin@dray.be> - 4.0.1
